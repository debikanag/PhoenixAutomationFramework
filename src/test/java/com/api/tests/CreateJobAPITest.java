...
public class CreateJobAPITest {
	...
	public void setup()
	{
		...
		CustomerProduct customerProduct = new CustomerProduct(DateTimeUtil.getTimeWithDaysAgo(10), "18836541958888",
				"18836541958888", "18836541958888", DateTimeUtil.getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
